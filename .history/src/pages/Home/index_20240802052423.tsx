...
const Home = () => {
  ...
  return (
    <div ref={backgroundRef}>
      ...
      {sideBarOpen && (
        <SidebarOpen ref={sidebarRef} style={{ display: 'flex', flexDirection: 'column', width: '250px' }}>
          <div style={{ padding: '10px', backgroundColor: '#333', color: '#fff', width: '100px', height: '60px' }}>
            User
          </div>
          <div style={{ padding: '10px', backgroundColor: '#333', color: '#fff', width: '100px' }}>
            보유
          </div>
          <List
            height={550} // 사이드바의 높이에서 연락처의 높이를 제외한 값
